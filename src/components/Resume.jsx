        ...
        <div id='resume-container' onClick={handleOnClose} className='fixed inset-0 bg-black bg-opacity-30 backdrop-blur-sm flex justify-center items-center text-white'>
            <div className='bg-white p-2 rounded flex flex-col  project-card'>
                <div className='flex flex-row items-center pb-2 z-50'>
                    <a href='https://drive.google.com/file/d/1-eXIHhACCS2bu8Ah9sa9-2ruZhXZ__dh/view?usp=drive_link' className={`${styles.filledButton} ml-1.5 py-2 px-4 text-[12px]`} target='_blank'>Download PDF</a>
                ...
                <a href='https://drive.google.com/file/d/1-eXIHhACCS2bu8Ah9sa9-2ruZhXZ__dh/view?usp=drive_link' target='_blank' className=' mb-[5px] flex justify-center items-center'>
