...
const ProjectCard = ({ title, category, description, link, stack, index }) => (
  <div className={`flex flex-col items-center p-6 rounded-[20px] ${index !== projects.length - 1 ? "mb-6" : "md-0"} project-card`}>
    <div className="border border-[#262626] rounded-[20px] h-[200px] w-[100%] sm:h-[296px] sm:w-[100%] mb-5"><img /></div>
    <div className="flex-1 flex flex-col ml-3 px-2">
      ...
      <p className="font-poppins text-[#999999] text-[0.75em] leading-[20px] mb-1">{description}</p>
      <LearnMoreBtn/>
    </div>
  </div>
)
